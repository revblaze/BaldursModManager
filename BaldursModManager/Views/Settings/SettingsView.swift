    ...
    VStack(spacing: 0) {
      ScrollView {
        VStack(alignment: .leading, spacing: 16) {
          ...
          ToggleWithHeader(isToggled: $userSettings.enableModOnImport, header: "Enable Mods on Import", description: "When a mod is imported into BaldursModManager, automatically install it and add it to modsettings.lsx for me.", showAllDescriptions: true)
            .disabled(!userSettings.enableMods)
