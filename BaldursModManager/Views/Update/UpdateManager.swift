...
extension Constants {
  ...
  static let releasesUrl: String = "https://github.com/revblaze/BaldursModManager/releases"
}
...
class UpdateManager {
  ...
  var checkForUpdatesErrorMessage: String? = nil
...
struct UpdateManagerKey: EnvironmentKey {
  static let defaultValue: UpdateManager = UpdateManager()
}
